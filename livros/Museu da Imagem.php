								...
								foreach($xml->foto as $foto){
									if ($foto->id == 001){
										...
										if (isset($_GET['categoria'])){
											if ($_GET['categoria'] == $foto->categoria){
										...
										echo "<a href='Museu%20da%20Imagem.php?categoria=".$foto->categoria."'>".$foto->categoria."</a></li>";
									}else{
										$verificador = 0;
									...
									if (count($id) == 1){
										...
										echo "<div class='item'>";
											...
											echo "<div class='carousel-caption'>";
												echo "<p>".$foto->nome."</p>";
												echo "<p><a href=''>".$foto->descricao."</a> Ano :<a href=''>".$foto->ano."</a></p>";
											echo "</div>";
										echo "</div>";				
								}
							}
									...
									if (($foto->categoria) == ($_GET['categoria'])){
										...
										if (count($id) == 1){
											...
											echo "<div class='item'>";
												...
												echo "<div class='carousel-caption'>";
													echo "<p>".$foto->nome."</p>";
													echo "<p><a href=''>".$_GET['categoria']."</a> Ano :<a href=''>".$foto->ano."</a></p>";
												echo "</div>";
											echo "</div>";	
									}
								}
