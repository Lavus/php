...
-moz-background-size: 100% 100%;
           ...
           #Patrocinio
    {
	  width:100px;
	  height:100px;
	  background-image: url(imagens/americanas.jpg);
	  background-size:100% 100%;
-webkit-background-size: 100% 100%;
-o-background-size: 100% 100%;
-khtml-background-size: 100% 100%;
...
-moz-background-size: 100% 100%;
           ...
           #outrosanuncios
    {
	  width:100px;
	  height:100px;
	  background-image: url(imagens/edelweiss.jpg);
	  background-size:100% 100%;
-webkit-background-size: 100% 100%;
-o-background-size: 100% 100%;
-khtml-background-size: 100% 100%;
...
$campo=array('link overmouse','link overmouse','link overmouse','link overmouse','link overmouse','link overmouse');
   ...
   <table align="right" id="table3">
    <tr><td>R$40,00</td></tr><br>
	<tr><td><input type="submit" name="comprar" value="Comprar"></td></tr>
	<tr><td>Sem limite de compra</td></tr>	
   </table>
   <table align="center" id="table4">
    <tr><td><h2>Promoção pascoa feliz,50%+ovos coloridos</h2></td></tr>
	<tr><td><div id="divmagem2" align="right"></div></td></tr>
	<tr><td><h4>-50% de desconto<br>-ovos coloridos<br>-R$80,00 por R$40,00 economia de R$40,00</h4></td></tr>	
   </table>
   <table align="center" id="table5">
    <tr><td><input type="submit" name="maps" value="localização" id="button"></td></tr>
      ...
      <table align="right" id="table6">
		<?php
       $campo=array('Patrocinio','Patrocinio','outrosanuncios','outrosanuncios','outrosanuncios');
      for($x=0;$x<5;$x++){
       echo('<tr><td>');
        echo('<a href="exibe4.php?opicao='.$campo[$x].'&order=desc"><div id="'.$campo[$x].'" align="right"></div></a>');
       echo('</td></tr>');
      } 
      ?> 
   </table>
