...
?>
    ...
    echo('<a href="gerenciarpagina.php?codigo='.$linha['codigo'].'">');
    ...
    echo('<h3><a href="gerenciarpagina.php?codigo='.$linha['codigo'].'">'.$linha["titulo"].'</a></h3>');
    //mais de um item echo('<h3><a href="gerenciarpagina.php?codigo='.$codigo.'&order=asc">'.$linha["titulo"].'</a></h3>');
    echo('<div class="productblurb-img">');
    echo('<a href="gerenciarpagina.php?codigo='.$linha['codigo'].'"><img src="upload/'.$linha["imagem"].'" width="148" height="116" alt="" title="'.$linha["titulo"].'"></a>');
    echo('<a class="visorpreco" href="gerenciarpagina.php?codigo='.$linha['codigo'].'">R$ '.$linha["valor"].'</a>');
    echo('</div>');
